...
import { addNewOrganization, addNewStakeholder, addToWhitelist } from "./Commands";
...
function Admin() {
  ...
  const orgSubmit = async (e) => {
    ...
    try {
      // console.log(add)
      const result = await addNewOrganization(name, address, token);
    ...
    <div>
      ...
      <div className="mt-32 flex justify-between">
        <div className="container mx-auto mt-8">
          <div className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-slate-400 uppercase justify-center shadow-md rounded px-8 py-6 text-white">
            Add Organization
          </div>
        ...
        <div className="container mx-auto mt-8">
          <div className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-rose-300 uppercase justify-center shadow-md rounded px-8 py-6 text-white">
            Add Stakeholder
          </div>
          <form className="max-w-md mx-auto bg-rose-200 shadow-md rounded px-8 py-6" onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name">
                Stakeholder Address
              </label>
      ...
      <div className="flex justify-center items-center mt-10 mb-10">
        <div className="container mx-auto mt-8">
          <div className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-violet-300 uppercase justify-center shadow-md rounded px-8 py-6 text-white">
            Whitelist Stakeholder
          </div>
          <form className="max-w-md mx-auto bg-violet-200 shadow-md rounded px-8 py-6" onSubmit={whiteListSubmit}>
            <div className="mb-4">
